...
const char *path = "dataset/webget-all-simplify.dat";
const char *res_path_cmp = "result/result_web/WEB_CMP.csv";
const char *res_param_path = "result/result_web/WEB_CMP.csv";
const char *res_path_cmp_pie = "result/result_web/web_pie_02.csv";
int TOPNUMBER = 10;
double log_base = 1.2;
              ...
              double FRT, int NET, int NCE, int LAM, int THE, int MORS, int FTHRES)
{
    ...
    // resfile_cmp << "FLOW_THRESH = " << FLOW_THRES_CMP << ", PORTION_THRESH=" << PORTION_THRES_CMP << "LOG_BASE=" << log_base << endl;
    // ;
...
int main()
{
    ...
    double param_filter_percent_range[] = {0.01};     //! 不需要过滤器 后续删除！提高吞吐量
    int param_theta_range[] = {1};                    //* 2
    int param_lambda_range[] = {1,2,3,4,5};                   //* 2
    int param_ncells_range[] = {32};              //* 32
    int param_nentries_range[] = {8};             //todo 8->16 !!!!!!!
    int param_mor_size_range[] = {8};          //* 8
    int param_flow_thres = 100;                         // 100
    ...
    // int pie_cmp_flow_thres = 500;
    // double pie_cmp_portion_thres = 0.05;
