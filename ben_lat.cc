...
const char *path = "dataset/caida2016_lat.txt";
const char *res_path_cmp = "result/result_lat/LAT_CMP.csv";
const char *res_param_path = "result/result_lat/lat_para_T&L.csv";
const char *res_path_cmp_pie = "result/result_lat/lat_pie_03.csv";
int TOPNUMBER = 10;
                     ...
                     int flow_thres, double portion_thres)
{
    ...
    {
        it1->gap++;
        it1->gap = (log(it1->gap) / log(log_base) + 1); // 取log
    }
    //! 区间化！！！
              ...
              double FRT, int NET, int NCE, int LAM, int THE, int MORS, int FTHRES)
{
    ...
    for (int i = 0; i < S1; i++)
    {
        ...
        hists[i] = new Hist_01<uint64_t>(MEM_RANGE[i], 16, 0.3); // n_slots & cm_ratio,默认配置
...
int main()
{
    ...
    // // // // // //!  参数调节！
    // int param_mem_range[] = {600};
    // int param_filter_thresh_range[] = {10};
    // double param_filter_percent_range[] = {0.025};
    // int param_theta_range[] = {3}; //* 3
    // int param_lambda_range[] = {1,2,3,4,5};   //* 2
    // int param_ncells_range[] = {8};   //* 8
    // int param_nentries_range[] = {8}; //* 8      //???        田忌赛马一下？？？？？
    // int param_mor_size_range[] = {8}; //* 8     //!DONE!!
